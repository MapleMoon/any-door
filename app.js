...
const operUrl = require('./lib/openUrl');
...
class Server {
    ...
    start() {
        ...
        server.listen(this.conf.port, this.conf.hostname, () => {
            operUrl(`http://${this.conf.hostname}:${this.conf.port}`);
            console.log(`Server started at ${chalk.green(this.conf.hostname + ':' + this.conf.port)}`);
        });
